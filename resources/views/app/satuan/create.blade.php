                ...
                <div class="p-5 bg-white rounded-3 border col-xl-6">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input class="form-control @error('kode_satuan') is-invalid @enderror" type="text" name="kode_satuan" id="kode_satuan" value="{{ old('kode_satuan') }}" placeholder="Masukan kode satuan" maxlength="10">
                            @error('kode_satuan') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-12 mb-3">
                            <label for="nama_satuan" class="form-label">Nama Satuan</label>
                            <input class="form-control @error('nama_satuan') is-invalid @enderror" type="text" name="nama_satuan" id="nama_satuan" value="{{ old('nama_satuan') }}" placeholder="Masukan nama satuan">
