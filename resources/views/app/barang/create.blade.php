                    ...
                    <form action="{{ route('barang.store') }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input class="form-control @error('kode_barang') is-invalid @enderror" type="text" name="kode_barang" id="kode_barang" value="{{ old('kode_barang') }}" placeholder="Masukan Kode Barang">
